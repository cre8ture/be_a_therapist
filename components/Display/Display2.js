...
import Description from '../Menus/TopMenu';
...
const TwoColumnLayout = () => {
    ...
    console.log("isPersonChanged in display", isPersonChanged)
  return (
    <div>
        <Description setIsPersonChanged={setIsPersonChanged} setPerson={setPerson} />
 
    <div style={{ display: 'flex', border: '1px solid lightblue', margin: '3px', padding: '5px' }}>
      <div style={{ flex: 3,padding: '5px'  }}>
        <ChatDisplay setIsPersonChanged={setIsPersonChanged} isPersonChanged={isPersonChanged} person={person} setMessagesForDisplay={setMessagesForDisplay} setIsSum2={setIsSum} setPlanner={setPlanner}/>
      </div>
