...
import { PromptTemplate } from "../../components/langchain/langchain/dist/prompts";

import { MemoryVectorStore } from "../../components/langchain/langchain/dist/vectorstores/memory";
import { OpenAIEmbeddings } from "../../components/langchain/langchain/dist/embeddings/openai";
import { VectorStoreRetrieverMemory } from "../../components/langchain/langchain/dist/memory"
...
export default async function handler(req, res) {// Run the middleware
